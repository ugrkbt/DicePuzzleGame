...
public class Level14 : MonoBehaviour {
    ...
    void Awake()
    {
        ...
        Matris.MatrisEkle(7, 1);
        Matris.MatrisEkle(7, 2);
    ...
    void Bitis()
    {
        Instantiate(bitis, new Vector3(3, -0.625f, -3), Quaternion.identity);
    }
    void Zar()
    {
    ...
    void altı()
    {
        Instantiate(asagi, new Vector3(-1, -0.625f, -2), Quaternion.identity);
    }
    void birx()
    {
    ...
    void ücx()
    {
        Instantiate(yukari, new Vector3(0, -0.625f, -5), Quaternion.identity);
    }
    ...
    void altiZemin()
    {
        Instantiate(alti, new Vector3(-3, -0.625f, -1), Quaternion.identity);
    }
    void bir1()
    {
        Instantiate(obje, new Vector3(-3, -0.625f, 0), Quaternion.identity);
    }
    void iki1()
    {
        Instantiate(obje, new Vector3(-3, -0.625f, -2), Quaternion.identity);
    }
    void üc1()
    {
    ...
    void bes3()
    {
        Instantiate(obje, new Vector3(3, -0.625f, -5), Quaternion.identity);
    }
