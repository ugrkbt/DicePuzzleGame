...
public class Level13 : MonoBehaviour {
    ...
    void Bitis()
    {
        Instantiate(bitis, new Vector3(3, -0.625f, 0), Quaternion.identity);
    }
    void Zar()
    {
    ...
    void ücx()
    {
        Instantiate(geri, new Vector3(2, -0.625f, -4), Quaternion.identity);
    }
    ...
    void altiZemin()
    {
        Instantiate(alti, new Vector3(0, -0.625f, -4), Quaternion.identity);
    }
    void bir1()
    {
    ...
    void dört1()
    {
        Instantiate(obje, new Vector3(3, -0.625f, -1), Quaternion.identity);
    }
    void bes1()
    {
